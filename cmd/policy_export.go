	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		case *pango.Firewall:
			...
			if t == "all" {
				...
				secfile := fmt.Sprintf("%s_Security.csv", f)
			...
			if t == "all" {
				...
				natfile := fmt.Sprintf("%s_NAT.csv", f)
			...
			if t == "all" {
				...
				pbffile := fmt.Sprintf("%s_PBF.csv", f)
			...
			if t == "decrypt" {
				...
				decryptfile := fmt.Sprintf("%s.csv", f)
			...
			if t == "all" {
				...
				decryptfile := fmt.Sprintf("%s_Decryption.csv", f)
